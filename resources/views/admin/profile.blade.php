    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{url('admin/index')}}\{{$user->email}}\{{$user->password}}">
            <img src="http://localhost/gcs1007/public/admin/assets/images/logo.svg" alt="logo" /> </a>
          <a class="navbar-brand brand-logo-mini" href="{{url('admin/index')}}\{{$user->email}}\{{$user->password}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('admin/customer-order/' . $user->email . '/' . $user->password) }}">Customer's Order</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <div class="col-lg-4">
              <div class="card mb-4">
                <div class="card-body text-center">
                  <img src="http://localhost/gcs1007/public/admin/assets/images/faces/face8.jpg" alt="avatar"
                    class="rounded-circle img-fluid" style="width: 150px;">
                  <h5 class="my-3">{{ $user->FirstName . ' ' . $user->LastName }}</h5>
                  <div class="d-flex justify-content-center mb-2">
                    <a href="{{ url('admin/customer-edit/' . $user->email) }}\{{$user->password}}\{{$user->UserID}}">
                        <button type="button" class="btn btn-primary" title="Edit this product">Edit</button>
                    </a>
                </div>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0">{{ $user->UserPhone}}</p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      @foreach ($country as $item)
                        @if($user->CounID== $item->CounID)
                        <p class="text-muted mb-0">{{ $item->CounName}}</p>
                        @endif
                      @endforeach
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      @foreach ($city as $item)
                        ...
                        <p class="text-muted mb-0">{{ $item->CityName}}</p>
                        @endif
                      @endforeach
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                    <p class="text-muted mb-0">{{$user->UserAddress}}
                    </div>
                    </div>
                  </div>
                  <hr>

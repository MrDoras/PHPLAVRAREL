          ...
          <div class="container mt-3" style="margin-top:20px">
              ...
              <form action="{{url('admin/product-update')}}" method="POST">
                  ...
                  <div class="mb-3">
                      ...
                      <img src="http://localhost/gcs1007/public/pro_img/{{ $data->productImage }}" height="90px" width="100px"><br>               
                  ...
                  <a href="{{url('admin/product-list')}}\{{$user->email}}\{{$user->password}}" class="btn btn-primary">Back</a>
              </form>
          </div>
      </body>
          <!-- partial -->

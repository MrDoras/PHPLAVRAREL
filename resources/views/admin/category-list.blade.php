            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/dropdowns.html">Add New Customer</a>
                  </li>
                  <li class="nav-item">
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                              <td>{{$pro->catID}}</td>
                              <td>{{$pro->catName}}</td>
                              <td>{{$pro->catDescriptions}}</td>
                              <td>                       
                                <a href="{{url('admin/category-edit/' . $user->email . '/' . $user->password) }}\{{$pro->catID}}" title="Edit this product"><i class="bi bi-pencil-fill"></i></a> &nbsp;
                                <a href="{{ url('admin/category-delete/' . $pro->catID) }}" title="Delete this product" onclick="return confirm('Are you sure you want to delete this product?');">

    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{url('admin/index')}}\{{$data->email}}\{{$data->password}}">
            <img src="http://localhost/gcs1007/public/admin/assets/images/logo.svg" alt="logo" /> </a>
          <a class="navbar-brand brand-logo-mini" href="{{url('admin/index')}}\{{$data->email}}\{{$data->password}}">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 font-weight-semibold">{{ $data->FirstName . ' ' . $data->LastName }}</p>
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">{{ $data->FirstName . ' ' . $data->LastName }}</p>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-1">
                  <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/Add/' . $data->email . '/' . $data->password) }}">Add New Customer</a>
                    </li>
                  </ul>
                </div>
            </li>
        ...
        <body>
            <div class="container mt-3" style="margin-top:20px">
                ...
                @endif
                  <form action="{{url('admin/product-save')}}" method="POSt">
                  @csrf
                    <div class="mb-3 mt-3">
                    ...
                    <a href="{{url('admin/product-list' . $data->email . '/' . $data->password)}}"class="btn btn-danger">Back</a>
                  </form>
            </div>
        </body>
        </html>

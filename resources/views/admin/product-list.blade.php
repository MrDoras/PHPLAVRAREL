          ...
          <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="http://localhost/gcs1007/public/pro_img/{{$pro->productImage}}" title="{{$pro->productDetails}}"
                            style="height:100px;width:120px">
                        </td>
                    <td>{{$pro->catID}}</td>
                    <td>
                        <a href="{{url('admin/product-edit/' . $user->email . '/' . $user->password) }}\{{$pro->productID}}" title="Edit this product"><i class="bi bi-pencil-fill"></i></a> &nbsp;
                        <a href="{{url('admin/product-delete')}}\{{$pro->productID}}" title="Delete this product" onclick="return confirm('Are you sure delete this product?');"><i class="bi bi-x-square"></i></a> &nbsp;
                    </td>
                </tr>
                @endforeach    
              </tbody>

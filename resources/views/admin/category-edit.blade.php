              ...
              <form action="{{url('admin/category-update')}}" method="POST">
                  ...
                  <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="id" 
                             value="{{$data->catID}}" readonly name="id">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3 mt-3">
                      ...
                      <textarea class="form-control" rows="5" id="Descriptions" name="Descriptions">
                          {{$data->catDescriptions}}
                      </textarea>
                  </div>

                  <button type="submit" class="btn btn-primary">Update</button>
                  <a href="{{url('admin/category-list'. $user->email . '/' . $user->password) }}" class="btn btn-primary">Back</a>
              </form>
          </div>
      </body>
          <!-- partial -->

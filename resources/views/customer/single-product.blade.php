        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="{{url('user/index')}}\{{$user->email}}" class="logo">
    ...
    <section class="section" id="product">
        <div class="container">
            ...
            <div class="col-lg-4">
                ...
                @endif
                  <form action="{{url('user/index/cart-save')}}\{{$user->email}}\{{$user->password}}" method="POSt">
                  @csrf
                    @csrf
                    <input type="hidden" name="id" value="{{$data->productID}}">
                    <input type="hidden" name="Name" value="{{$data->productName}}">
                    <input type="hidden" name="Price" value="{{$data->productPrice}}">
                    <input type="hidden" name="Image" value="{{$data->productImage}}">
                    <input type="hidden" name="Details" value="{{$data->productDetails}}">
                    <input type="hidden" name="category" value="{{$data->catID}}">
                    ...
                    <div class="total">
                      ...
                      <h4>{{$data->productPrice}}$</h4>
                        ...
                        <form action="{{url('user/index/purchase')}}\{{$user->email}}\{{$user->password}}" method="POSt">
                            @csrf
                              @csrf
                                 <input type="hidden" name="cartID" value="Buy">
                              <input type="hidden" name="id" value="{{$data->productID}}">
                              <input type="hidden" name="Name" value="{{$data->productName}}">
                              <input type="hidden" name="Price" value="{{$data->productPrice}}">
                              <input type="hidden" name="Image" value="{{$data->productImage}}">
